...
const Footer = () => {
  return (
    <div className="w-[100%] pl-6 md:pl-18 pt-3 md:pt-8">
      <div className="">
      ...
      <div className="flex flex-col md:flex-row gap-x-32 mb-10 mt-12">
        <div className="">
          ...
          <p className="mt-5">&#169;Zepto Technologies Private Limited</p>
        </div>
        ...
        <div className="mt-8">
          <div>
            ...
            <div className="flex flex-col gap-3 w-[200px] md:w-full ">
              <button className="mb-2 mt-2 border-2 px-0 md:px-5 py-3 rounded-md flex flex-row justify-center items-center gap-3" onClick={()=>window.open("https://play.google.com/store/apps/details?id=com.zeptoconsumerapp&pli=1")}>
                <BsGooglePlay className="text-[20px]" />
                Get it on Playstore
              </button>
              <button className="mb-2 border-2 px-4 md:px-5 py-3 rounded-md flex flex-row justify-center items-center gap-3" onClick={()=>window.open("https://apps.apple.com/in/app/zepto-grocery-delivery/id1575323645")}>
