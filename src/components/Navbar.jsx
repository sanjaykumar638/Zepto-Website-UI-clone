    ...
    <>
      <div className="bg-[#450072] flex flex-row h-[80px] w-[100%] items-center justify-around md:justify-evenly">
        ...
        <div>
          <input
            type="text"
            className="hidden md:flex md:w-[300px] lg:w-[600px] h-[40px] rounded-lg px-8"
        ...
        <Link to='/cart' >
        {
          ...
          <button className="hidden sm:flex bg-[#FF3269] text-white text-[13px] md:text-[16px] font-semibold px-4 md:px-7  rounded-lg lg:flex mr-10 h-[60px] items-center justify-center">
